...
-- Started on 2012-05-05 19:28:15 CEST
...
--
-- TOC entry 178 (class 1255 OID 16835)
-- Dependencies: 6 500
...
--
-- TOC entry 179 (class 1255 OID 16836)
-- Dependencies: 6 500
...
--
-- TOC entry 161 (class 1259 OID 16837)
-- Dependencies: 2749 6
...
--
-- TOC entry 162 (class 1259 OID 16841)
-- Dependencies: 6 161
...
--
-- TOC entry 163 (class 1259 OID 16843)
-- Dependencies: 6
...
SELECT pg_catalog.setval('solarsystem_solarsystemid_seq', 36, true);
...
--
-- TOC entry 2748 (class 2604 OID 16851)
...
--
-- TOC entry 2750 (class 2604 OID 16852)
...
--
-- TOC entry 2766 (class 0 OID 16837)
-- Dependencies: 161
...
INSERT INTO heavenlybody (heavenlybodyid, name, diameter, color, type) VALUES (17, 'Helios', 40, '0:255:0:255    ', 'S');


--
-- TOC entry 2767 (class 0 OID 16843)
-- Dependencies: 163
...
INSERT INTO solarsystem (solarsystemid, name, centralstarid) VALUES (36, 'Kollision', 17);


--
-- TOC entry 2768 (class 0 OID 16848)
-- Dependencies: 165
...
INSERT INTO solarsystemtoheavenlybody (solarsystemid, heavenlybodyid, excentricity, semimajoraxis, angle, orbitalplaneangle) VALUES (36, 26, 0.299999999999999989, 20, 0, -45);
INSERT INTO solarsystemtoheavenlybody (solarsystemid, heavenlybodyid, excentricity, semimajoraxis, angle, orbitalplaneangle) VALUES (36, 26, 0.299999999999999989, 20, 0, 45);


--
-- TOC entry 2752 (class 2606 OID 16854)
...
--
-- TOC entry 2754 (class 2606 OID 16856)
-- Dependencies: 161 161
...
--
-- TOC entry 2756 (class 2606 OID 16858)
...
--
-- TOC entry 2758 (class 2606 OID 16860)
-- Dependencies: 163 163
...
--
-- TOC entry 2760 (class 2606 OID 16862)
...
--
-- TOC entry 2764 (class 2620 OID 16863)
-- Dependencies: 163 179
...
--
-- TOC entry 2765 (class 2620 OID 16864)
-- Dependencies: 165 178
...
--
-- TOC entry 2762 (class 2606 OID 16865)
...
--
-- TOC entry 2763 (class 2606 OID 16870)
...
--
-- TOC entry 2761 (class 2606 OID 16875)
...
-- Completed on 2012-05-05 19:28:15 CEST
